...
borderGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(150, 255, 200)),
    ColorSequenceKeypoint.new(0.25, Color3.fromRGB(150, 220, 255)),
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 180, 255)),
    ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 220, 150)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(150, 255, 200))
})
...
Side.Name = "Side"
Side.Parent = Main
Side.BackgroundColor3 = Color3.fromRGB(60, 60, 70) -- 与主背景相同的颜色
...
function library.new(library, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        Tab.ScrollBarThickness = 6 -- 增加滚动条厚度
        Tab.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 120)
        ...
        TabL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            local contentSize = TabL.AbsoluteContentSize.Y + 20 -- 增加额外空间
        ...
        function tab.section(tab, name, TabVal)
            ...
            Section.Parent = Tab
            Section.BackgroundColor3 = Color3.fromRGB(55, 55, 65) -- 更亮的灰色
