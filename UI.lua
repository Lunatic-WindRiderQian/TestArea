...
local config = {
MainColor = Color3.fromRGB(80, 80, 80), -- 改为深灰色
	TabColor = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Bg_Color = Color3.fromRGB(100, 100, 100), -- 改为灰色
	Zy_Color = Color3.fromRGB(80, 80, 80), -- 改为深灰色
	Button_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Textbox_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Dropdown_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Keybind_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Label_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Slider_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	SliderBar_Color = Color3.fromRGB(37, 254, 152),
	Toggle_Color = Color3.fromRGB(60, 60, 60), -- 改为深灰色
	Toggle_Off = Color3.fromRGB(40, 40, 40), -- 改为更深灰色
...
function library.new(library, name, theme)
	...
	Main.BackgroundColor3 = config.Bg_Color -- 使用灰色
	Main.BorderColor3 = config.MainColor -- 使用深灰色
	...
	MainCorner.CornerRadius = UDim.new(0, 12) -- 设置圆角半径为12
	...
	Side.Name = "Side"
	Side.Parent = SB
	Side.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- 左侧边栏改为灰色
	Side.BorderColor3 = Color3.fromRGB(100, 100, 100) -- 左侧边栏改为灰色
	...
	SideCorner.CornerRadius = UDim.new(0, 8) -- 设置圆角半径为8
	SideG.Color =
    ...
    Separator.Position = UDim2.new(0.8, 0, 0.2, 0)
