...
local isElectron = issirhurt_closure and true or false
...
function library.new(name, theme)
    ...
    FengYu.Name = "REN"
    protectGUI(FengYu)
    FengYu.Parent = game:GetService("CoreGui")
    ...
    Open.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(Open, TweenInfo.new(0.2), {Rotation = Open.Rotation + 180}):Play()
    end)
    ...
    SideG.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0.00, config.Zy_Color), ColorSequenceKeypoint.new(1.00, config.Zy_Color) })
    SideG.Rotation = 90
    SideG.Name = "SideG"
    SideG.Parent = Side
    ...
    SBG.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0.00, config.Zy_Color), ColorSequenceKeypoint.new(1.00, config.Zy_Color) })
    SBG.Rotation = 90
    SBG.Name = "SBG"
    SBG.Parent = SB
    ...
    task.spawn(function()
        ...
        while ScriptTitle and ScriptTitle.Parent do
            ...
            TweenService:Create(ScriptTitle, TweenInfo.new(1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    function window:Tab(name, icon)
        ...
        function tab:Section(name, TabVal)
            ...
            SectionToggle.MouseButton1Click:Connect(function()
                ...
                TweenService:Create(SectionOpened, TweenInfo.new(0.2), {
                    ImageTransparency = (open and 0 or 1)
                }):Play()
                
                TweenService:Create(SectionOpen, TweenInfo.new(0.2), {
            ...
            function section:Textbox(text, flag, default, callback)
                ...
                TextboxBack.MouseEnter:Connect(function()
                    TweenService:Create(TextboxBack, TweenInfo.new(0.2), {
                        BackgroundColor3 = Color3.fromRGB(
            ...
            function section:Slider(text, flag, default, min, max, precise, callback)
                ...
                createAuroraEffect(SliderPart, 0.6)
