...
Main.BackgroundColor3 = Color3.fromRGB(60, 60, 70) -- 更亮的灰色背景
...
borderGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(100, 255, 180)),   -- 亮绿色
    ColorSequenceKeypoint.new(0.25, Color3.fromRGB(100, 200, 255)), -- 亮蓝色
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 150, 255)),  -- 亮紫色
    ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 200, 100)), -- 亮橙色
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(100, 255, 180))   -- 亮绿色
})
...
GlassEffect.BackgroundColor3 = Color3.fromRGB(70, 70, 80)  -- 更亮的灰色
...
Side.Name = "Side"
Side.Parent = Main
Side.BackgroundColor3 = Color3.fromRGB(50, 50, 60)  -- 灰色（原来是黑色）
...
SideGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(55, 55, 65)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(60, 60, 70))
})
...
function library.new(library, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
            ...
            Section.Parent = Tab
            Section.BackgroundColor3 = Color3.fromRGB(50, 50, 60)  -- 灰色
            ...
            function section.Button(section, text, callback)
                ...
                Btn.BackgroundColor3 = Color3.fromRGB(50, 50, 60)  -- 灰色
