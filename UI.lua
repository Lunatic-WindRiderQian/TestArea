...
Main.BackgroundColor3 = Color3.fromRGB(40, 40, 50) -- 更亮的灰色背景
...
borderGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(37, 254, 152)),   -- 绿色
    ColorSequenceKeypoint.new(0.25, Color3.fromRGB(0, 200, 255)),  -- 蓝色
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 100, 255)), -- 紫色
    ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 150, 50)), -- 橙色
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(37, 254, 152))   -- 绿色
})

-- 创建动画效果让边框颜色循环变化
local borderAnimation
borderAnimation = RunService.RenderStepped:Connect(function()
    local time = tick()
    local offset = (time % 5) / 5  -- 5秒循环
...
GlassEffect.BackgroundColor3 = Color3.fromRGB(50, 50, 60)  -- 更亮的灰色
...
GlassGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(50, 50, 60)),
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(60, 60, 70)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(50, 50, 60))
})
...
Side.Name = "Side"
Side.Parent = Main
Side.BackgroundColor3 = Color3.fromRGB(35, 35, 45)  -- 更亮的灰色
...
SideGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(40, 40, 50)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(45, 45, 55))
})
...
titleAnimation = RunService.RenderStepped:Connect(function()
    local time = tick()
    local offset = (time % 3) / 3  -- 3秒循环
...
function library.new(library, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
            ...
            Section.Parent = Tab
            Section.BackgroundColor3 = Color3.fromRGB(35, 35, 45)  -- 更亮的灰色
            ...
            -- 彩色展开图标
            local openedGradient = Instance.new("UIGradient")
            openedGradient.Parent = SectionOpened
            openedGradient.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0.0, Color3.fromRGB(37, 254, 152)),   -- 绿色
                ColorSequenceKeypoint.new(0.25, Color3.fromRGB(0, 200, 255)),  -- 蓝色
                ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 100, 255)), -- 紫色
                ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 150, 50)), -- 橙色
            ...
            function section.Button(section, text, callback)
                ...
                Btn.BackgroundColor3 = Color3.fromRGB(35, 35, 45)  -- 更亮的灰色
