...
GlassEffect.BackgroundColor3 = Color3.fromRGB(15, 15, 25)
...
ParticleEffect.Size = UDim2.new(1, 0, 1, 0)
...
local function createParticle(position)
    ...
    particle.ZIndex = 0
    particle.Parent = ParticleEffect
...
-- 添加一些静态粒子
createParticle(UDim2.new(0.1, 0, 0.2, 0))
createParticle(UDim2.new(0.8, 0, 0.3, 0))
createParticle(UDim2.new(0.3, 0, 0.7, 0))
createParticle(UDim2.new(0.7, 0, 0.8, 0))
createParticle(UDim2.new(0.2, 0, 0.5, 0))
...
SideGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(20, 20, 30)),
...
TitleGlow.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, config.AccentColor),
