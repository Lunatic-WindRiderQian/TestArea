...
local Library do 
    ...
    Library = {
        ...
        _ProjectorModeEnabled = false,
        _ProjectorObjects = nil,
        _ProjectorSettings = {
            distance = 8,
            width = 12,
            height = 8,
    ...
    Library.Unload = function(self)
        ...
        if Library.BlurInstances then
            for _, blur in ipairs(Library.BlurInstances) do
                pcall(function() if typeof(blur) == "Instance" then blur:Destroy() end end)
            end
    ...
    Library._NotifyKeybindFlagListeners = function(flag)
        if not flag or not Library.KeybindFlagListeners then return end
    ...
    do
        ...
        Instances:Create("UICorner", {Parent = TooltipFrame.Instance, CornerRadius = UDimNew(0, 5)})
        Instances:Create("UIStroke", {Parent = TooltipFrame.Instance, Color = FromRGB(40, 38, 46), Thickness = 1})
        Instances:Create("UIPadding", {Parent = TooltipFrame.Instance, PaddingLeft = UDimNew(0, TooltipPadX), PaddingRight = UDimNew(0, TooltipPadX)})
        ...
        Library.ShowTooltip = function(self, Text)
            ...
            TooltipVisible = true
            Tween:Create(TooltipFrame, TweenInfo.new(0.15), {BackgroundTransparency = 0.08})
            Tween:Create(TooltipLabel, TweenInfo.new(0.15), {TextTransparency = 0})
        end

        Library.HideTooltip = function(self)
            TooltipVisible = false
            Tween:Create(TooltipFrame, TweenInfo.new(0.1), {BackgroundTransparency = 1})
            Tween:Create(TooltipLabel, TweenInfo.new(0.1), {TextTransparency = 1})
            task.delay(0.12, function()
                if not TooltipVisible then TooltipFrame.Instance.Visible = false end
            end)
        end
        ...
        Library.AttachTooltip = function(self, GuiObj, Text)
            ...
            pcall(function() Library:Connect(inst.MouseEnter, function() Library:ShowTooltip(Text) end) end)
            pcall(function() Library:Connect(inst.MouseLeave, function() Library:HideTooltip() end) end)
        end
    end
    ...
    do 
        Library.CreateColorpicker = function(self, Data)
            ...
            local Items = { } do
                ...
                Instances:Create("UICorner", {Parent = Items["Color"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UIGradient", {Parent = Items["Saturation"].Instance, Transparency = NumSequence{NumSequenceKeypoint(0, 1), NumSequenceKeypoint(1, 0)}})
                Instances:Create("UICorner", {Parent = Items["Saturation"].Instance, CornerRadius = UDimNew(0, 4)})
                ...
                Instances:Create("UIGradient", {Parent = Items["Value"].Instance, Rotation = 90, Transparency = NumSequence{NumSequenceKeypoint(0, 1), NumSequenceKeypoint(1, 0)}})
                Instances:Create("UICorner", {Parent = Items["Value"].Instance, CornerRadius = UDimNew(0, 4)})
                Instances:Create("UICorner", {Parent = Items["Palette"].Instance, CornerRadius = UDimNew(0, 4)})
                ...
                Instances:Create("UIStroke", {Parent = Items["PaletteDragger"].Instance, Color = FromRGB(255, 255, 255), ApplyStrokeMode = Enum.ApplyStrokeMode.Border})
                Instances:Create("UICorner", {Parent = Items["PaletteDragger"].Instance})
                ...
                Instances:Create("UICorner", {Parent = Items["Hue"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UICorner", {Parent = Items["HueInline"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UICorner", {Parent = Items["HueDragger"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UICorner", {Parent = Items["Alpha"].Instance, CornerRadius = UDimNew(1, 0)})
                Instances:Create("UIGradient", {Parent = Items["Alpha"].Instance, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(0, 0, 0)), RGBSequenceKeypoint(1, FromRGB(255, 255, 255))}})
                ...
                Instances:Create("UICorner", {Parent = Items["AlphaDragger"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UIGridLayout", {Parent = Items["SavedColors"].Instance, SortOrder = Enum.SortOrder.LayoutOrder, CellPadding = UDim2New(0, 10, 0, 10), CellSize = UDim2New(0, 25, 0, 25)})
                Instances:Create("UIPadding", {Parent = Items["SavedColors"].Instance, PaddingLeft = UDimNew(0, 5), PaddingTop = UDimNew(0, 5), PaddingRight = UDimNew(0, -125), PaddingBottom = UDimNew(0, 5)})
                ...
                Instances:Create("UIPadding", {Parent = Items["HEXInput"].Instance, PaddingLeft = UDimNew(0, 5)})
                ...
                Instances:Create("UICorner", {Parent = Items["HEXInput"].Instance, CornerRadius = UDimNew(0, 4)})                
            end
            ...
            function AddColor(Color)
                ...
                Instances:Create("UICorner", {Parent = SavedColor.Instance, CornerRadius = UDimNew(0, 6)})
            ...
            AddColor(Colors["Orange"]) AddColor(Colors["Pink"]) AddColor(Colors["Purple"]) AddColor(Colors["Pink 2"]) AddColor(Colors["Pink 3"])
            AddColor(Colors["Yellow"]) AddColor(Colors["Orange 2"]) AddColor(Colors["Orange 3"]) AddColor(Colors["Green"]) AddColor(Colors["Blue"])
            AddColor(Colors["Maroon"]) AddColor(Colors["Whiteish Pink"]) AddColor(Colors["White"]) AddColor(Colors["Red"]) AddColor(Colors["Sky Blue"])
        ...
        Library.KeybindList = function(self, Title)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["KeybindsList"].Instance})
                ...
                Instances:Create("UIGradient", {Parent = Items["Icon"].Instance, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(131, 131, 131)), RGBSequenceKeypoint(1, FromRGB(255, 255, 255))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                ...
                Instances:Create("UICorner", {Parent = Items["Top"].Instance})
                Instances:Create("Frame", {Parent = Items["Top"].Instance, AnchorPoint = Vector2New(0, 1), Position = UDim2New(0, 0, 1, 0), BorderColor3 = FromRGB(0, 0, 0), Size = UDim2New(0, 10, 0, 5), BorderSizePixel = 0, BackgroundColor3 = FromRGB(31, 31, 36)}):AddToTheme({BackgroundColor3 = "Section Background 2"})
                Instances:Create("Frame", {Parent = Items["Top"].Instance, AnchorPoint = Vector2New(1, 1), Position = UDim2New(1, 0, 1, 0), BorderColor3 = FromRGB(0, 0, 0), Size = UDim2New(0, 10, 0, 5), BorderSizePixel = 0, BackgroundColor3 = FromRGB(31, 31, 36)}):AddToTheme({BackgroundColor3 = "Section Background 2"})
                ...
                Instances:Create("UIPadding", {Parent = Items["Content"].Instance, PaddingTop = UDimNew(0, 8), PaddingBottom = UDimNew(0, 8), PaddingRight = UDimNew(0, 8), PaddingLeft = UDimNew(0, 8)})
                Instances:Create("UIPadding", {Parent = Items["KeybindsList"].Instance, PaddingRight = UDimNew(0, 12)})                
            end
            ...
            function KeybindList:Add(Name, Key)
                ...
                Instances:Create("UICorner", {Parent = NewKeyAccent.Instance})
        ...
        Library.Notification = function(self, Data)
            local Items = { } do 
                ...
                Instances:Create("UIPadding", {Parent = Items["Notification"].Instance, PaddingTop = UDimNew(0, 10), PaddingBottom = UDimNew(0, 10), PaddingRight = UDimNew(0, 10), PaddingLeft = UDimNew(0, 10)})
                Instances:Create("UIListLayout", {Parent = Items["Notification"].Instance, FillDirection = Enum.FillDirection.Vertical, Padding = UDimNew(0, 8), SortOrder = Enum.SortOrder.LayoutOrder, HorizontalAlignment = Enum.HorizontalAlignment.Center, VerticalAlignment = Enum.VerticalAlignment.Top})
                Items["HeaderRow"] = Instances:Create("Frame", {Parent = Items["Notification"].Instance, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 18), BorderSizePixel = 0, LayoutOrder = 1, BackgroundColor3 = FromRGB(255, 255, 255)})
                Items["Title"] = Instances:Create("TextLabel", {
                ...
                if not Data.IconColor then
                    ...
                    Instances:Create("UIGradient", {Parent = Items["Icon"].Instance, Rotation = -115, Color = RGBSequence{RGBSequenceKeypoint(0, Data.IconColor.Start), RGBSequenceKeypoint(1, Data.IconColor.End)}})
                end
                ...
                Items["AccentHolder"] = Instances:Create("Frame", {Parent = Items["Notification"].Instance, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 4), BorderSizePixel = 0, ClipsDescendants = true, LayoutOrder = 3, BackgroundColor3 = FromRGB(255, 255, 255)})
                ...
                Instances:Create("UICorner", {Parent = Items["Accent"].Instance, CornerRadius = UDimNew(1, 0)})
                Instances:Create("UIGradient", {Parent = Items["Accent"].Instance, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
            end
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                if IsMobile then 
                    Items["MobileUIScale"] = Instances:Create("UIScale", {Parent = Items["MainFrame"].Instance, Name = "\0", Scale = (Data.MobileScale or 0.74) * 0.88})
                else
                ...
                -- Resize corner (hidden by default)
                do
                    ...
                    Items["ResizeCorner"]:OnHover(function() ResizeIcon:Tween(TweenInfo.new(0.15), {ImageTransparency = 0}) end)
                    Items["ResizeCorner"]:OnHoverLeave(function() if not CornerResizing then ResizeIcon:Tween(TweenInfo.new(0.15), {ImageTransparency = 0.5}) end end)
                    ...
                    Library:Connect(UserInputService.InputEnded, function(Input)
                        if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and CornerResizing then
                            ...
                            ResizeIcon:Tween(TweenInfo.new(0.15), {ImageTransparency = 0.5})
                        end
                    end)
                    Library:Connect(RunService.RenderStepped, function()
                ...
                Instances:Create("UICorner", {Parent = Items["LeftTabs"].Instance, CornerRadius = UDimNew(0, WINDOW_CORNER_RADIUS)})
                ...
                Instances:Create("UIGradient", {Parent = Items["Logo"].Instance, Enabled = true, Rotation = -115, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                Items["Title"] = Instances:Create("TextLabel", {
                    Parent = Items["Topbar"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                ...
                Items["ButtonGroup"] = Instances:Create("Frame", {
                    Parent = Items["Topbar"].Instance,
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(0, 180, 1, 0),
                    Position = UDim2New(1, -190, 0, 0),
                    ZIndex = 5
                })
                local function createTopbarButton(iconAsset, callback)
                    local btn = Instances:Create("TextButton", {
                        Parent = Items["ButtonGroup"].Instance,
                        Name = "\0",
                        Text = "",
                        AutoButtonColor = false,
                    ...
                    local bg = Instances:Create("Frame", {
                        Parent = btn.Instance,
                        Name = "\0",
                    ...
                    bg:AddToTheme({BackgroundColor3 = "Element"})
                    Instances:Create("UICorner", {Parent = bg.Instance, CornerRadius = UDimNew(0, 8)})
                    ...
                    btn:OnHover(function() bg:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 0.8}) end)
                    btn:OnHoverLeave(function() bg:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 0.95}) end)
                    btn:Connect("MouseButton1Down", callback)
                    return btn
                end

                Items["ProjectorBtn"] = createTopbarButton("rbxassetid://12684119225", function()
                    if Window._ProjectorModeEnabled then Window:DisableProjectorMode() else Window:EnableProjectorMode() end
                end)
                Items["MinimizeBtn"] = createTopbarButton("", function() Window:SetOpen(false) end)
                Library:SetIcon(Items["MinimizeBtn"].Instance:FindFirstChildWhichIsA("ImageLabel"), "minus")
                local resizeCornerVisible = false
                Items["ResizeToggleBtn"] = createTopbarButton("", function()
                    resizeCornerVisible = not resizeCornerVisible
                    Items["ResizeCorner"].Instance.Visible = resizeCornerVisible
                end)
                Library:SetIcon(Items["ResizeToggleBtn"].Instance:FindFirstChildWhichIsA("ImageLabel"), "square")
                Items["CloseBtn"] = createTopbarButton("", function() Library:Unload() end)
                Library:SetIcon(Items["CloseBtn"].Instance:FindFirstChildWhichIsA("ImageLabel"), "x")

                local buttonLayout = Instances:Create("UIListLayout", {
                    Parent = Items["ButtonGroup"].Instance,
                ...
                Items["ButtonGroup"].Instance.Size = UDim2New(0, 180, 1, 0)

                -- ========== DRAG LOGIC (Topbar based) ==========
                local dragging = false
                ...
                local function startDrag(input)
                    ...
                    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        dragStartWindowPos = Items["MainFrame"].Instance.Position
                ...
                local function onDragMove(input)
                    ...
                    if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
                        ...
                        Items["MainFrame"].Instance.Position = UDim2.new(
                ...
                Items["Topbar"]:Connect("InputBegan", startDrag)
                ...
                Instances:Create("UIListLayout", {Parent = Items["LeftTabsScroll"].Instance, Padding = UDimNew(0, 12), SortOrder = Enum.SortOrder.LayoutOrder})
                Instances:Create("UIPadding", {Parent = Items["LeftTabsScroll"].Instance, PaddingTop = UDimNew(0, 15), PaddingBottom = UDimNew(0, 15), PaddingRight = UDimNew(0, 12), PaddingLeft = UDimNew(0, 12)})
                ...
                Instances:Create("UICorner", {Parent = Items["Content"].Instance, CornerRadius = UDimNew(0, WINDOW_CORNER_RADIUS)})
                ...
                do
                    ...
                    Instances:Create("UIStroke", {Parent = Items["FloatingButton"].Instance, Thickness = 1.25, Transparency = 0.28, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Color = FromRGB(90, 165, 255)}):AddToTheme({Color = "Accent"})
                    ...
                    local FloatGrad = Instances:Create("UIGradient", {Parent = Items["FloatingLogo"].Instance, Enabled = false, Rotation = -115, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}})
                    FloatGrad:AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                    ...
                    Library:Connect(RunService.RenderStepped, function(dt)
                        if not floatDragging or not floatGrabOffset then return end
                        local inst = Items["FloatingButton"].Instance
                        ...
                        if (Vector2New(totalDx, totalDy)).Magnitude >= FLOAT_DRAG_PX then floatMoved = true end
                        if not floatMoved then return end
                        local psz = parent.AbsoluteSize
                        ...
                        local cx, cy = cur.X.Offset, cur.Y.Offset
                        local a = MathClamp(FLOAT_LERP * (1 / math.max(dt, 1 / 240)), 0.06, 0.32)
            ...
            function Window:Init()
                task.spawn(function()
                    ...
                    if firstPage and not firstPage.Active then firstPage:Turn(true) end
                    for __, Value in Window.Pages do 
                        if Value.Active then 
                            for _, Value2 in Value.Sections do 
                                task.spawn(function() Value2:TweenElements(true) end)
                            end
                        end
                    end
                end)
            ...
            function Window:SetTransparency()
                ...
                if Items["FloatingButton"] then
                    ...
                    if showFloat then Items["FloatingButton"].Instance.BackgroundTransparency = Library.Flags["BackgroundTransparency"] end
                end
            end
        ...
        -- ========== API RENAME: Category -> Page, Page -> Tab ==========
        Library.Page = function(self, Name)  -- renamed from Category
            local Items = { } do 
        ...
        Library.Tab = function(self, Data)  -- renamed from Page, single column
            Data = Data or { }
            local Tab = {
                Window = self,
            ...
            local Items = { } do
                Items["Inactive"] = Instances:Create("TextButton", {
                    Parent = Tab.Window.Items["LeftTabsScroll"].Instance,
                    Name = "\0",
                    LayoutOrder = Tab.TabLayoutOrder,
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(0, 0, 0),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Text = "",
                ...
                Instances:Create("UICorner", {Parent = Items["Inactive"].Instance, CornerRadius = UDimNew(0, 5)})
                Items.Gradient = Instances:Create("UIGradient", {Parent = Items["Inactive"].Instance, Transparency = NumSequence{NumSequenceKeypoint(0, 0.41874998807907104), NumSequenceKeypoint(0.445, 0.78125), NumSequenceKeypoint(0.751, 0.9375), NumSequenceKeypoint(1, 1)}})
                ...
                Instances:Create("UICorner", {Parent = Items["TabIndicator"].Instance, CornerRadius = UDimNew(1, 0)})
                Items["Icon"] = Instances:Create("ImageLabel", {
                    Parent = Items["Inactive"].Instance,
                    Name = "\0",
                    ImageColor3 = FromRGB(255, 255, 255),
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Library:SetIcon(Items["Icon"].Instance, Tab.Icon)
                Instances:Create("UIGradient", {Parent = Items["Icon"].Instance, Rotation = -115}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                Items["Text"] = Instances:Create("TextLabel", {
                    Parent = Items["Inactive"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                ...
                Instances:Create("UIListLayout", {Parent = NewColumn.Instance, Padding = UDimNew(0, 5), SortOrder = Enum.SortOrder.LayoutOrder})
                Tab.ColumnsData[1] = NewColumn
                Tab.Items = Items
            end

            local Debounce = false
            function Tab:InstantDeactivate()
                ...
                for _, Sec in Tab.Sections do
                    task.spawn(function() Sec:TweenElements(false, true) end)
                end
            end
            ...
            function Tab:Turn(Bool)
                ...
                if Tab.Active then
                    ...
                    Items["Page"].Instance.Parent = Tab.Window.Items["Content"].Instance
                    Items["Page"].Instance.GroupTransparency = 1
                    ...
                    for _, Sec in Tab.Sections do task.spawn(function() Sec:TweenElements(false, true) end) end
                    ...
                    if NewTween and NewTween.Tween then
                        Library:Connect(NewTween.Tween.Completed, function()
                            Library:Thread(function()
                                for _, Value in Tab.Sections do
                    ...
                    if NewTween and NewTween.Tween then
                        Library:Connect(NewTween.Tween.Completed, function()
                            Items["Page"].Instance.Visible = false
                            Items["Page"].Instance.Parent = Library.UnusedHolder.Instance
                            for Index, Value in Tab.Sections do 
            ...
            Items["Inactive"]:Connect("MouseButton1Down", function()
                ...
                for _, Value in Tab.Window.Pages do 
                    if Value == Tab and Tab.Active then return end
                end
                for _, Value in Tab.Window.Pages do 
                    if Value ~= Tab and Value.InstantDeactivate then Value:InstantDeactivate() end
                end
                Tab:Turn(true)
                W._tabCooldownUntil = now + (W.TabSwitchCooldownSec or 0.5)
            end)

            if #Tab.Window.Pages == 0 then Tab:Turn(true) end
            TableInsert(Tab.Window.Pages, Tab)
            return setmetatable(Tab, Library.Pages)
        end

        -- ========== SINGLE COLUMN SECTION (force Side=1) ==========
        Library.Pages.Section = function(self, Data)
            ...
            local Items = { } do
                ...
                Instances:Create("UICorner", {Parent = Items["TopBackground"].Instance, CornerRadius = UDimNew(0, 4)})
                Items["Title"] = Instances:Create("TextLabel", {
                    Parent = Items["TopBackground"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                ...
                Instances:Create("UICorner", {Parent = Items["Circle"].Instance, CornerRadius = UDimNew(0, 99999)})
                Instances:Create("UICorner", {Parent = Items["Toggle"].Instance, CornerRadius = UDimNew(0, 9)})
                Items["Gradient"] = Instances:Create("UIGradient", {Parent = Items["Toggle"].Instance, Rotation = -115, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                Instances:Create("UICorner", {Parent = Items["Top"].Instance, CornerRadius = UDimNew(0, 4)})
                ...
                Instances:Create("UICorner", {Parent = Items["Fill"].Instance, CornerRadius = UDimNew(0, 4)})
                Items["TopFills"] = Instances:Create("Frame", {Parent = Items["Top"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(0, 1), BackgroundTransparency = 1, Position = UDim2New(0, 0, 1, 0), Size = UDim2New(1, 0, 0, 3), BorderSizePixel = 0, BackgroundColor3 = FromRGB(255, 255, 255)})  
                Items["Right1"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(1, -1, 0, 0), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Items["Right2"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(1, -1, 0, 1), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Items["Right3"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(1, -2, 0, 1), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Items["Left1"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(0, 2, 0, 0), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Items["Left2"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(0, 2, 0, 1), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Items["Left3"] = Instances:Create("Frame", {Parent = Items["TopFills"].Instance, BorderColor3 = FromRGB(0, 0, 0), AnchorPoint = Vector2New(1, 0), BackgroundTransparency = 0.65, Position = UDim2New(0, 3, 0, 1), Size = UDim2New(0, 1, 0, 1), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(26, 26, 30)}):AddToTheme({BackgroundColor3 = "Section Background"})
                Instances:Create("UICorner", {Parent = Items["Section"].Instance, CornerRadius = UDimNew(0, 4)})
                ...
                Instances:Create("UIListLayout", {Parent = Items["Content"].Instance, Padding = UDimNew(0, 5), SortOrder = Enum.SortOrder.LayoutOrder})                
                ...
                Instances:Create("UICorner", {Parent = Items["Fade"].Instance, CornerRadius = UDimNew(0, 4)})                
                Instances:Create("UIPadding", {Parent = Items["Content"].Instance, PaddingBottom = UDimNew(0, 10)})
                Section.Items = Items
            end
            ...
            function Section:TweenElements(Bool, Debounce)
                for Index, Value in Section.Elements do Value:RefreshPosition(Bool) end
            end
        ...
        -- ========== PROJECTOR MODE FUNCTIONS ==========
        function Library:UpdateProjectorSizeFromUI(Window)
            ...
            targetWidth = MathClamp(targetWidth, 4, 24)
            targetHeight = MathClamp(targetHeight, 3, 16)
            Window._ProjectorObjects.Screen.Size = Vector3New(targetWidth, targetHeight, 0.1)
            Window._ProjectorSettings.width = targetWidth
            Window._ProjectorSettings.height = targetHeight
        end

        function Library:EnableProjectorMode(Window, distance, width, height, transparency)
            ...
            projectorScreen.Name = "Mentality_ProjectorScreen"
            ...
            projectorScreen.Size = Vector3New(width, height, 0.1)
            ...
            selectionBox.Color3 = Library.Theme.Accent
            ...
            surfaceGui.CanvasSize = Vector2New(1600, 1200)
            surfaceGui.ClipsDescendants = true
            surfaceGui.AlwaysOnTop = true
            surfaceGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
            surfaceGui.Adornee = projectorScreen
            surfaceGui.Parent = projectorScreen
            local screenGui = Window.Items["MainFrame"].Instance.Parent
            local originalChildren = {}
            for _, child in ipairs(screenGui:GetChildren()) do
                if child ~= Library.FloatingButtonWidget.Instance and child ~= Library.NotifHolder.Instance then
                    originalChildren[#originalChildren + 1] = child
                end
            end
            for _, child in ipairs(originalChildren) do child.Parent = surfaceGui end
            local pointLight = Instance.new("PointLight")
            pointLight.Brightness = 2.5
            pointLight.Range = 20
            pointLight.Color = Library.Theme.Accent
            ...
            local updateConnection = RunService.RenderStepped:Connect(function()
                if not projectorScreen.Parent then if updateConnection then updateConnection:Disconnect() end return end
                updateScreenPosition()
            end)
            local sizeConnection = Window.Items["MainFrame"].Instance:GetPropertyChangedSignal("Size"):Connect(function()
                if Window._ProjectorSettings.autoSize then Library:UpdateProjectorSizeFromUI(Window) end
            end)
            task.wait(0.1)
            Library:UpdateProjectorSizeFromUI(Window)
        ...
        function Library:DisableProjectorMode(Window)
            if not Window._ProjectorModeEnabled then return false end
            if Window._ProjectorObjects then
                if Window._ProjectorObjects.UpdateConnection then Window._ProjectorObjects.UpdateConnection:Disconnect() end
                if Window._ProjectorObjects.SizeConnection then Window._ProjectorObjects.SizeConnection:Disconnect() end
                if Window._ProjectorObjects.SurfaceGui then
                    local surfaceGui = Window._ProjectorObjects.SurfaceGui
                    for _, child in ipairs(surfaceGui:GetChildren()) do child.Parent = Window.Items["MainFrame"].Instance.Parent end
                end
                if Window._ProjectorObjects.Screen then Window._ProjectorObjects.Screen:Destroy() end
            end
        ...
        function Library:ToggleProjectorMode(Window)
            if Window._ProjectorModeEnabled then return Library:DisableProjectorMode(Window) else return Library:EnableProjectorMode(Window) end
        end

        local function attachProjectorMethods(win)
            win.EnableProjectorMode = function(self, dist, w, h, trans) return Library:EnableProjectorMode(self, dist, w, h, trans) end
            win.DisableProjectorMode = function(self) return Library:DisableProjectorMode(self) end
            win.ToggleProjectorMode = function(self) return Library:ToggleProjectorMode(self) end
            win.IsProjectorMode = function(self) return self._ProjectorModeEnabled end
            win.SetProjectorDistance = function(self, dist)
                self._ProjectorSettings.distance = MathClamp(dist, 3, 20)
                if self._ProjectorModeEnabled and self._ProjectorObjects then
                    local character = LocalPlayer.Character
                    if character and character:FindFirstChild("HumanoidRootPart") then
                        local rootPart = character.HumanoidRootPart
                        local forward = rootPart.CFrame.LookVector
                        forward = Vector3.new(forward.X, 0, forward.Z).Unit
                        local targetPos = rootPart.Position + forward * dist
                        targetPos = Vector3.new(targetPos.X, targetPos.Y + 1.2, targetPos.Z)
                        local lookAtPoint = Vector3.new(rootPart.Position.X, targetPos.Y, rootPart.Position.Z)
                        local screenCF = CFrame.lookAt(targetPos, lookAtPoint, Vector3.new(0, 1, 0))
                        self._ProjectorObjects.Screen.CFrame = screenCF
                    end
                end
            end
            win.SetProjectorSize = function(self, w, h)
                w = MathClamp(w, 4, 24)
                h = MathClamp(h, 3, 16)
                self._ProjectorSettings.width = w
                self._ProjectorSettings.height = h
                self._ProjectorSettings.autoSize = false
                if self._ProjectorModeEnabled and self._ProjectorObjects then self._ProjectorObjects.Screen.Size = Vector3New(w, h, 0.1) end
            end
            win.SetProjectorTransparency = function(self, trans)
                trans = MathClamp(trans, 0, 0.8)
                self._ProjectorSettings.transparency = trans
                if self._ProjectorModeEnabled and self._ProjectorObjects then self._ProjectorObjects.Screen.Transparency = trans end
            end
        end

        local originalWindow = Library.Window
        Library.Window = function(self, Data)
            local win = originalWindow(self, Data)
            attachProjectorMethods(win)
            return win
        end

        -- ========== DASHBOARD PAGE (unchanged, but ensures single column) ==========
        Library.DashboardPage = function(self, Data)
            ...
            local DashItems = {} do
                ...
                Instances:Create("UICorner", {Parent = DashItems["Inactive"].Instance, CornerRadius = UDimNew(0, 5)})
                DashItems.Gradient = Instances:Create("UIGradient", {Parent = DashItems["Inactive"].Instance, Transparency = NumSequence{NumSequenceKeypoint(0, 0.41874998807907104), NumSequenceKeypoint(0.445, 0.78125), NumSequenceKeypoint(0.751, 0.9375), NumSequenceKeypoint(1, 1)}})
                ...
                Instances:Create("UICorner", {Parent = DashItems["TabIndicator"].Instance, CornerRadius = UDimNew(1, 0)})
                ...
                Instances:Create("UIGradient", {Parent = DashItems["Icon"].Instance, Rotation = -115}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                ...
                Instances:Create("UIPadding", {Parent = DashItems["Page"].Instance, PaddingTop = UDimNew(0, 16), PaddingBottom = UDimNew(0, 16), PaddingRight = UDimNew(0, 16), PaddingLeft = UDimNew(0, 16)})
                local AvatarImage = ""
                pcall(function() AvatarImage = game.Players:GetUserThumbnailAsync(LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420) end)
                DashItems["HeroRow"] = Instances:Create("Frame", {Parent = DashItems["Page"].Instance, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 190), Position = UDim2New(0, 0, 0, 0), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                local LeftCol = Instances:Create("Frame", {Parent = DashItems["HeroRow"].Instance, BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 0), Size = UDim2New(0.57, -8, 1, 0), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                DashItems["WelcomeLabel"] = Instances:Create("TextLabel", {Parent = LeftCol.Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(160, 158, 180), Text = DashPage.WelcomeText, AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 16), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 0), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 12, BackgroundColor3 = FromRGB(255, 255, 255)})
                DashItems["HubName"] = Instances:Create("TextLabel", {Parent = LeftCol.Instance, FontFace = Library.Font, TextColor3 = FromRGB(255, 255, 255), Text = DashPage.HubName or Window.Name, AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 38), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 18), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 30, BackgroundColor3 = FromRGB(255, 255, 255)})
                Instances:Create("UIGradient", {Parent = DashItems["HubName"].Instance, Rotation = -90}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                DashItems["StatusText"] = Instances:Create("TextLabel", {Parent = LeftCol.Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(120, 118, 145), Text = DashPage.StatusText or Window.SubName, AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 16), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 62), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 13, BackgroundColor3 = FromRGB(255, 255, 255)})
                DashItems["LinksRow"] = Instances:Create("Frame", {Parent = LeftCol.Instance, BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 86), Size = UDim2New(1, 0, 0, 30), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                Instances:Create("UIListLayout", {Parent = DashItems["LinksRow"].Instance, FillDirection = Enum.FillDirection.Horizontal, VerticalAlignment = Enum.VerticalAlignment.Center, Padding = UDimNew(0, 6), SortOrder = Enum.SortOrder.LayoutOrder})
                for _, link in DashPage.Links do
                    local linkBtn = Instances:Create("TextButton", {Parent = DashItems["LinksRow"].Instance, AutoButtonColor = false, Text = "", BorderSizePixel = 0, Size = UDim2New(0, 30, 0, 30), ZIndex = 3, BackgroundTransparency = 0.1, BackgroundColor3 = FromRGB(30, 28, 38)}):AddToTheme({BackgroundColor3 = "Element"})
                    local linkHoverRing = Instances:Create("Frame", {Parent = linkBtn.Instance, Active = false, AnchorPoint = Vector2New(0.5, 0.5), Position = UDim2New(0.5, 0, 0.5, 0), Size = UDim2New(1, 8, 1, 8), BackgroundTransparency = 1, BorderSizePixel = 0, ZIndex = 1, BackgroundColor3 = FromRGB(100, 149, 255)}):AddToTheme({BackgroundColor3 = "Accent"})
                    Instances:Create("UICorner", {Parent = linkHoverRing.Instance, CornerRadius = UDimNew(1, 0)})
                    Instances:Create("UICorner", {Parent = linkBtn.Instance, CornerRadius = UDimNew(1, 0)})
                    local linkStroke = Instances:Create("UIStroke", {Parent = linkBtn.Instance, Thickness = 2.25, LineJoinMode = Enum.LineJoinMode.Round, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Transparency = 1}):AddToTheme({Color = "Accent"})
                    local linkIcon = Instances:Create("ImageLabel", {Parent = linkBtn.Instance, AnchorPoint = Vector2New(0.5, 0.5), Position = UDim2New(0.5, 0, 0.5, 0), Size = UDim2New(0, 16, 0, 16), BackgroundTransparency = 1, BorderSizePixel = 0, ZIndex = 4, BackgroundColor3 = FromRGB(255, 255, 255)})
                    Library:SetIcon(linkIcon.Instance, link.Icon or "link")
                    Instances:Create("UIGradient", {Parent = linkIcon.Instance, Rotation = -115}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                    ...
                    linkBtn:OnHover(function()
                        linkBtn:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 0})
                        linkHoverRing:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 0.35})
                        if linkStroke and linkStroke.Instance then TweenService:Create(linkStroke.Instance, TweenInfo.new(0.2), {Transparency = 0.06}):Play() end
                    end)
                    linkBtn:OnHoverLeave(function()
                        linkBtn:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 0.1})
                        linkHoverRing:Tween(TweenInfo.new(0.2), {BackgroundTransparency = 1})
                        if linkStroke and linkStroke.Instance then TweenService:Create(linkStroke.Instance, TweenInfo.new(0.25), {Transparency = 1}):Play() end
                    end)
                    if link.Tooltip then Library:AttachTooltip(linkBtn.Instance, link.Tooltip) end
                end
                do local d1 = Instances:Create("Frame", {Parent = LeftCol.Instance, BackgroundColor3 = FromRGB(38, 36, 44), Position = UDim2New(0, 0, 0, 119), Size = UDim2New(1, 0, 0, 1), BorderSizePixel = 0, ZIndex = 2, BackgroundTransparency = 0,}) d1:AddToTheme({BackgroundColor3 = "Outline"}) end
                DashItems["GameName"] = Instances:Create("TextLabel", {Parent = LeftCol.Instance, FontFace = Library.Font, TextColor3 = FromRGB(245, 244, 255), Text = DashPage.GameName, AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 28), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 126), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 22, BackgroundColor3 = FromRGB(255, 255, 255)}):AddToTheme({TextColor3 = "Text"})
                DashItems["GameDesc"] = Instances:Create("TextLabel", {Parent = LeftCol.Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(120, 118, 148), Text = DashPage.GameDescription, Size = UDim2New(1, 0, 0, 40), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 156), TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top, TextWrapped = true, BorderSizePixel = 0, ZIndex = 2, TextSize = 12, BackgroundColor3 = FromRGB(255, 255, 255)})
                do local d2 = Instances:Create("Frame", {Parent = LeftCol.Instance, BackgroundColor3 = FromRGB(38, 36, 44), Position = UDim2New(0, 0, 0, 197), Size = UDim2New(1, 0, 0, 1), BorderSizePixel = 0, ZIndex = 2, BackgroundTransparency = 0,}) d2:AddToTheme({BackgroundColor3 = "Outline"}) end
                local RightCol = Instances:Create("Frame", {Parent = DashItems["HeroRow"].Instance, BackgroundTransparency = 1, Position = UDim2New(0.59, 0, 0, 0), Size = UDim2New(0.41, 0, 1, 0), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                DashItems["AvatarRing"] = Instances:Create("Frame", {Parent = RightCol.Instance, AnchorPoint = Vector2New(1, 0), Position = UDim2New(1, 0, 0, 0), Size = UDim2New(0, 58, 0, 58), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(40, 38, 48)}):AddToTheme({BackgroundColor3 = "Element"})
                Instances:Create("UICorner", {Parent = DashItems["AvatarRing"].Instance, CornerRadius = UDimNew(1, 0)})
                Instances:Create("UIStroke", {Parent = DashItems["AvatarRing"].Instance, Thickness = 2}):AddToTheme({Color = "Accent"})
                DashItems["Avatar"] = Instances:Create("ImageLabel", {Parent = DashItems["AvatarRing"].Instance, Image = AvatarImage, AnchorPoint = Vector2New(0.5, 0.5), Position = UDim2New(0.5, 0, 0.5, 0), Size = UDim2New(1, -4, 1, -4), BackgroundTransparency = 1, BorderSizePixel = 0, ZIndex = 3, BackgroundColor3 = FromRGB(255, 255, 255)})
                Instances:Create("UICorner", {Parent = DashItems["Avatar"].Instance, CornerRadius = UDimNew(1, 0)})
                DashItems["PlayerName"] = Instances:Create("TextLabel", {Parent = RightCol.Instance, FontFace = Library.Font, TextColor3 = FromRGB(225, 223, 240), Text = LocalPlayer.DisplayName, AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 18), BackgroundTransparency = 1, AnchorPoint = Vector2New(1, 0), Position = UDim2New(1, 0, 0, 64), TextXAlignment = Enum.TextXAlignment.Right, BorderSizePixel = 0, ZIndex = 2, TextSize = 14, BackgroundColor3 = FromRGB(255, 255, 255)}):AddToTheme({TextColor3 = "Text"})
                DashItems["Badge"] = Instances:Create("TextLabel", {Parent = RightCol.Instance, FontFace = Library.Font, TextColor3 = FromRGB(255, 255, 255), Text = " " .. (DashPage.Badge or "PLAYER") .. " ", AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 20), BackgroundTransparency = 0, AnchorPoint = Vector2New(1, 0), Position = UDim2New(1, 0, 0, 86), TextXAlignment = Enum.TextXAlignment.Center, BorderSizePixel = 0, ZIndex = 3, TextSize = 11, BackgroundColor3 = FromRGB(100, 140, 255)}):AddToTheme({BackgroundColor3 = "Accent"})
                Instances:Create("UICorner", {Parent = DashItems["Badge"].Instance, CornerRadius = UDimNew(1, 0)})
                DashItems["StatsContainer"] = Instances:Create("Frame", {Parent = RightCol.Instance, BackgroundTransparency = 1, AnchorPoint = Vector2New(1, 0), Position = UDim2New(1, 0, 0, 114), Size = UDim2New(1, 0, 0, 0), AutomaticSize = Enum.AutomaticSize.Y, BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                Instances:Create("UIListLayout", {Parent = DashItems["StatsContainer"].Instance, Padding = UDimNew(0, 5), SortOrder = Enum.SortOrder.LayoutOrder})
                DashItems["StatItems"] = {}
                local function AddStat(Name, GetValue, Icon)
                    local statFrame = Instances:Create("Frame", {Parent = DashItems["StatsContainer"].Instance, BackgroundTransparency = 1, Size = UDim2New(1, 0, 0, 18), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                    local statIcon = Instances:Create("ImageLabel", {Parent = statFrame.Instance, AnchorPoint = Vector2New(0, 0.5), Position = UDim2New(0, 0, 0.5, 0), Size = UDim2New(0, 13, 0, 13), BackgroundTransparency = 1, BorderSizePixel = 0, ZIndex = 3, BackgroundColor3 = FromRGB(255, 255, 255)})
                    Library:SetIcon(statIcon.Instance, Icon or "activity")
                    Instances:Create("UIGradient", {Parent = statIcon.Instance, Rotation = -115}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                    Instances:Create("TextLabel", {Parent = statFrame.Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(100, 98, 125), Text = StringLower(Name), AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 1, 0), BackgroundTransparency = 1, Position = UDim2New(0, 18, 0, 0), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 12, BackgroundColor3 = FromRGB(255, 255, 255)})
                    local statVal = Instances:Create("TextLabel", {Parent = statFrame.Instance, FontFace = Library.Font, TextColor3 = FromRGB(215, 215, 235), Text = "—", AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 1, 0), BackgroundTransparency = 1, AnchorPoint = Vector2New(1, 0), Position = UDim2New(1, 0, 0, 0), TextXAlignment = Enum.TextXAlignment.Right, BorderSizePixel = 0, ZIndex = 2, TextSize = 12, BackgroundColor3 = FromRGB(255, 255, 255)}):AddToTheme({TextColor3 = "Text"})
                    DashItems["StatItems"][Name] = {Frame = statFrame, Value = statVal, GetValue = GetValue}
                end
                for _, StatData in DashPage.Stats do AddStat(StatData.Name or "Stat", StatData.GetValue, StatData.Icon) end
                if #DashPage.Stats > 0 then
                    Library:Connect(RunService.Heartbeat, function()
                        for _, StatInfo in DashItems["StatItems"] do if StatInfo.GetValue then local ok, val = pcall(StatInfo.GetValue) if ok and val ~= nil then StatInfo.Value.Instance.Text = tostring(val) end end end
                    end)
                end
                DashItems["Sep1"] = Instances:Create("Frame", {Parent = DashItems["Page"].Instance, BackgroundColor3 = FromRGB(38, 36, 46), Position = UDim2New(0, 0, 0, 196), Size = UDim2New(0.59, -12, 0, 1), BorderSizePixel = 0, ZIndex = 2, BackgroundTransparency = 0}):AddToTheme({BackgroundColor3 = "Element"})
                DashItems["QASep"] = Instances:Create("TextLabel", {Parent = DashItems["Page"].Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(80, 78, 102), Text = "QUICK ACCESS", AutomaticSize = Enum.AutomaticSize.X, Size = UDim2New(0, 0, 0, 16), BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 206), TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0, ZIndex = 2, TextSize = 11, BackgroundColor3 = FromRGB(255, 255, 255)})
                DashItems["QARow"] = Instances:Create("Frame", {Parent = DashItems["Page"].Instance, BackgroundTransparency = 1, Position = UDim2New(0, 0, 0, 228), Size = UDim2New(1, 0, 1, -228), BorderSizePixel = 0, ZIndex = 2, BackgroundColor3 = FromRGB(255, 255, 255)})
                Instances:Create("UIListLayout", {Parent = DashItems["QARow"].Instance, FillDirection = Enum.FillDirection.Horizontal, Padding = UDimNew(0, 10), SortOrder = Enum.SortOrder.LayoutOrder})
                DashItems["QACards"] = {}
                local AddQuickCard = function(CardData, Index)
                    local numCards = #DashPage.QuickAccess
                    local card = Instances:Create("TextButton", {Parent = DashItems["QARow"].Instance, AutoButtonColor = false, Text = "", BackgroundColor3 = FromRGB(22, 21, 26), BorderSizePixel = 0, Size = UDim2New(1 / numCards, Index < numCards and -8 or 0, 1, 0), ZIndex = 2, BackgroundTransparency = 0}):AddToTheme({BackgroundColor3 = "Section Background 2"})
                    Instances:Create("UICorner", {Parent = card.Instance, CornerRadius = UDimNew(0, 6)})
                    local cardStroke = Instances:Create("UIStroke", {Parent = card.Instance, Color = FromRGB(38, 36, 46), Thickness = 1, Transparency = 0})
                    local cardIcon = Instances:Create("ImageLabel", {Parent = card.Instance, AnchorPoint = Vector2New(0.5, 0), Position = UDim2New(0.5, 0, 0, 22), Size = UDim2New(0, 28, 0, 28), BackgroundTransparency = 1, BorderSizePixel = 0, ZIndex = 3, BackgroundColor3 = FromRGB(255, 255, 255)})
                    Library:SetIcon(cardIcon.Instance, CardData.Icon or "layout-grid")
                    Instances:Create("UIGradient", {Parent = cardIcon.Instance, Rotation = -115}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                    Instances:Create("TextLabel", {Parent = card.Instance, FontFace = Library.Font, TextColor3 = FromRGB(225, 224, 240), Text = CardData.Name or "Tab", Size = UDim2New(1, -20, 0, 18), BackgroundTransparency = 1, AnchorPoint = Vector2New(0.5, 0), Position = UDim2New(0.5, 0, 0, 56), TextXAlignment = Enum.TextXAlignment.Center, BorderSizePixel = 0, ZIndex = 2, TextSize = 14, BackgroundColor3 = FromRGB(255, 255, 255)})
                    Instances:Create("TextLabel", {Parent = card.Instance, FontFace = Library.Fonts.Light, TextColor3 = FromRGB(100, 98, 130), Text = CardData.Description or "", Size = UDim2New(1, -20, 0, 32), BackgroundTransparency = 1, AnchorPoint = Vector2New(0.5, 0), Position = UDim2New(0.5, 0, 0, 78), TextXAlignment = Enum.TextXAlignment.Center, TextWrapped = true, BorderSizePixel = 0, ZIndex = 2, TextSize = 12, BackgroundColor3 = FromRGB(255, 255, 255)})
                    card:OnHover(function()
                        card:Tween(TweenInfo.new(0.2), {BackgroundColor3 = FromRGB(30, 28, 36)})
                        Tween:Create(cardStroke, TweenInfo.new(0.2), {Color = Library.Theme.Accent, Transparency = 0}, true)
                    end)
                    card:OnHoverLeave(function()
                        card:Tween(TweenInfo.new(0.2), {BackgroundColor3 = Library.Theme["Section Background 2"]})
                        Tween:Create(cardStroke, TweenInfo.new(0.2), {Color = FromRGB(38, 36, 46), Transparency = 0}, true)
                    end)
                    card:Connect("MouseButton1Down", function()
                        if type(CardData.Tab) == "table" and CardData.Tab.Turn then
                            ...
                            for _, P in DashPage.Window.Pages do if P == target and target.Active then return end end
                            for _, P in DashPage.Window.Pages do if P ~= target and P.InstantDeactivate then P:InstantDeactivate() end end
                            target:Turn(true)
                            W._tabCooldownUntil = now + (W.TabSwitchCooldownSec or 0.5)
                        elseif type(CardData.Callback) == "function" then Library:SafeCall(CardData.Callback) end
                    end)
                    DashItems["QACards"][Index] = card
                end
                for i, CardData in DashPage.QuickAccess do AddQuickCard(CardData, i) end
            ...
            function DashPage:Turn(Bool)
                ...
                if Bool then
                    ...
                    if NewTween and NewTween.Tween then
                        Library:Connect(NewTween.Tween.Completed, function() DashDebounce = false end)
                    else DashDebounce = false end
                else
            ...
            function DashPage:AddCard(CardData)
                ...
                local numCards = #DashPage.QuickAccess
                for i, card in DashItems["QACards"] do card.Instance.Size = UDim2New(1 / numCards, i < numCards and -8 or 0, 1, 0) end
            end
            DashItems["Inactive"]:Connect("MouseButton1Down", function()
                local W = DashPage.Window
                local now = tick()
                if now < (W._tabCooldownUntil or 0) then return end
                for _, Value in DashPage.Window.Pages do if Value == DashPage and DashPage.Active then return end end
                for _, Value in DashPage.Window.Pages do if Value ~= DashPage and Value.InstantDeactivate then Value:InstantDeactivate() end end
                DashPage:Turn(true)
                W._tabCooldownUntil = now + (W.TabSwitchCooldownSec or 0.5)
            end)
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["Indicator"].Instance, CornerRadius = UDimNew(0, 3)})
                Items["Accent"] = Instances:Create("Frame", {
                ...
                Instances:Create("UICorner", {Parent = Items["Accent"].Instance, CornerRadius = UDimNew(0, 3)})
                ...
                })  Items["Gradient"]:AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
            ...
            function Toggle:Settings(Size)
                ...
                SettingsItem = { } do 
                    ...
                    Instances:Create("UICorner", {Parent = SettingsItem["Settings"].Instance, CornerRadius = UDimNew(0, 6)})                    
                    ...
                    Instances:Create("UIListLayout", {Parent = SettingsItem["Content"].Instance, Padding = UDimNew(0, 4), SortOrder = Enum.SortOrder.LayoutOrder})
                    Instances:Create("UIPadding", {Parent = SettingsItem["Content"].Instance, PaddingTop = UDimNew(0, 4), PaddingBottom = UDimNew(0, 4), PaddingRight = UDimNew(0, 4), PaddingLeft = UDimNew(0, 4)})
                    ...
                    SettingsItem["Gradient"] = Instances:Create("UIGradient", {
                        ...
                        Rotation = -115,
                        Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}
                    })  SettingsItem["Gradient"]:AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                    Instances:Create("UICorner", {Parent = SettingsItem["Accent"].Instance, CornerRadius = UDimNew(0, 4)})
                    Instances:Create("UICorner", {Parent = SettingsItem["Button"].Instance, CornerRadius = UDimNew(0, 4)})
                ...
                function Settings:SetOpen(Bool)
                    ...
                    if Settings.IsOpen then 
                        task.spawn(function()
                            for Index, Value in Settings.Elements do Value:RefreshPosition(true) task.wait(0.03) end
                        end)
                        ...
                        for Index, Value in Library.OpenFrames do if Value ~= Settings then Value:SetOpen(false) end end
                        Library.OpenFrames[Settings] = Settings 
                    else
                        for Index, Value in Settings.Elements do Value:RefreshPosition(false) end
                    ...
                    for Index, Value in Descendants do 
                        local TransparencyProperty = Tween:GetProperty(Value)
                        if not TransparencyProperty then continue end
                        if not Value.ClassName:find("UI") then Value.ZIndex = Settings.IsOpen and 7 or 1 end
                        if type(TransparencyProperty) == "table" then 
                            for _, Property in TransparencyProperty do NewTween = Tween:FadeItem(Value, Property, Bool, Library.FadeSpeed) end
                        else NewTween = Tween:FadeItem(Value, TransparencyProperty, Bool, Library.FadeSpeed) end
                    end
                    NewTween.Tween.Completed:Connect(function()
                        Debounce = false 
                ...
                SettingsItem["SettingsIcon"]:Connect("InputBegan", function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then Settings:SetOpen(not Settings.IsOpen) end
                end)
                Library:Connect(UserInputService.InputBegan, function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then 
                        if Library:IsMouseOverFrame(SettingsItem["Settings"]) then return end
            ...
            Items["Toggle"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then 
                    if Items["SettingsIcon"] and Library:IsMouseOverFrame(Items["SettingsIcon"]) then return end
        ...
        Library.Sections.Button = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["Accent"].Instance, CornerRadius = UDimNew(0, 4)})
                Instances:Create("UICorner", {Parent = Items["Button"].Instance, CornerRadius = UDimNew(0, 4)})
                Items["Text"] = Instances:Create("TextLabel", {
                    Parent = Items["Button"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
            ...
            function Button:Press()
                ...
                if Button.Icon then Items["Icon"]:Tween(nil, {ImageColor3 = FromRGB(0, 0, 0), ImageTransparency = 0}) end
                task.wait(0.2)
                Library:SafeCall(Button.Callback)
                Items["Button"]:ChangeItemTheme({BackgroundColor3 = "Element"})
                Items["Button"]:Tween(nil, {BackgroundColor3 = Library.Theme.Element})
                Items["Text"]:Tween(nil, {TextColor3 = Library.Theme.Text, TextTransparency = 0.3})
                if Button.Icon then Items["Icon"]:Tween(nil, {ImageColor3 = Library.Theme.Text, ImageTransparency = 0.3}) end
            end
        ...
        Library.Sections.Slider = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["RealSlider"].Instance})
                Items["Accent"] = Instances:Create("Frame", {
                ...
                Instances:Create("UICorner", {Parent = Items["Accent"].Instance})
                Items["Icon"] = Instances:Create("ImageLabel", {
                    Parent = Items["Accent"].Instance,
                    Name = "\0",
                    BorderColor3 = FromRGB(0, 0, 0),
                ...
                Instances:Create("UIGradient", {Parent = Items["Accent"].Instance, Rotation = -102, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(166, 166, 166))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
            ...
            Items["Value"]:Connect("FocusLost", function()
                ...
                if n then Slider:Set(n) else Items["Value"].Instance.Text = StringFormat("%s%s", Slider.Value, Slider.Suffix) end
            end)
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["RealDropdown"].Instance, CornerRadius = UDimNew(0, 6)})
                ...
                Instances:Create("UIStroke", {Parent = Items["OptionHolder"].Instance, Color = FromRGB(35, 33, 38), ApplyStrokeMode = Enum.ApplyStrokeMode.Border}):AddToTheme({Color = "Outline"})
                Instances:Create("UICorner", {Parent = Items["OptionHolder"].Instance, CornerRadius = UDimNew(0, 5)})
                ...
                Instances:Create("UIListLayout", {Parent = Items["Holder"].Instance, Padding = UDimNew(0, 4), SortOrder = Enum.SortOrder.LayoutOrder})
                if Dropdown.SearchEnabled then
                    ...
                    Instances:Create("UICorner", {Parent = Items["SearchField"].Instance, CornerRadius = UDimNew(0, 5)})
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    if not Dropdown.IsOpen then
                        for Index, Value in Dropdown.OptionsWithIndexes do task.spawn(function() Value:RefreshPosition(false) end) end
                    end
            ...
            function Dropdown:Add(Option)
                ...
                Instances:Create("UIGradient", {Parent = OptionAccent.Instance, Enabled = true, Rotation = -115, Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}}):AddToTheme({Color = function() return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)} end})
                Instances:Create("UICorner", {Parent = OptionAccent.Instance})
                ...
                function OptionData:Set()
                    ...
                    if Dropdown.Multi then 
                        ...
                        if OptionData.Selected then 
                            ...
                            OptionData:Toggle("Active")
                            for Index, Value in Dropdown.Options do 
                                if Value ~= OptionData then Value.Selected = false Value:Toggle("Inactive") end
                            end
            ...
            function Dropdown:Remove(Option)
                ...
                if Dropdown.FilterRows then Dropdown.FilterRows[Option] = nil end
            end

            function Dropdown:Refresh(List)
                for _, opt in pairs(Dropdown.Options) do Dropdown:Remove(opt.Name) end
                List = List or {}
                for _, Value in ipairs(List) do Dropdown:Add(Value) end
            end
        ...
        Library.Sections.Label = function(self, Name)
            ...
            function Label:Colorpicker(Data)
                ...
                if not Items["SubElements"] then
                    ...
                    Instances:Create("UICorner", {Parent = Items["SubElements"].Instance, CornerRadius = UDimNew(0, 5)})
                    Instances:Create("UIListLayout", {Parent = Items["SubElements"].Instance, VerticalAlignment = Enum.VerticalAlignment.Center, FillDirection = Enum.FillDirection.Horizontal, Padding = UDimNew(0, 5), SortOrder = Enum.SortOrder.LayoutOrder})
                    Instances:Create("UIPadding", {Parent = Items["SubElements"].Instance, PaddingLeft = UDimNew(0, 6)})                
                end
                local NewColorpicker = Library:CreateColorpicker({
                    Parent = Items["SubElements"],
                    Page = Label.Page,
        ...
        Library.Sections.Keybind = function(self, Data)
            ...
            if syncFlag == "" then syncFlag = nil end
            ...
            local Items = { } do
                ...
                Instances:Create("UICorner", {Parent = Items["Modes"].Instance, CornerRadius = UDimNew(0, 5)})
                Instances:Create("UIStroke", {Parent = Items["Modes"].Instance, Thickness = 1, Transparency = 0.5, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Color = FromRGB(60, 90, 160)}):AddToTheme({Color = "Accent"})
                ...
                Instances:Create("UICorner", {Parent = Items["ModeList"].Instance, CornerRadius = UDimNew(0, 5)})
                Instances:Create("UIListLayout", {Parent = Items["ModeList"].Instance, FillDirection = Enum.FillDirection.Vertical, Padding = UDimNew(0, 0), SortOrder = Enum.SortOrder.LayoutOrder})
                ...
                local function closeModeMenu()
                    ...
                    if Keybind._modeMenuConn then Keybind._modeMenuConn:Disconnect() Keybind._modeMenuConn = nil end
                end
                ...
                Items["ModeSelect"]:Connect("MouseButton1Click", function()
                    if Items["ModeList"].Instance.Visible then closeModeMenu() return end
                    positionModeList()
                    Items["ModeList"].Instance.Size = UDim2New(0, Items["Modes"].Instance.AbsoluteSize.X, 0, 66)
                    Items["ModeList"].Instance.Visible = true
                    if Keybind._modeMenuConn then Keybind._modeMenuConn:Disconnect() end
                    Keybind._modeMenuConn = UserInputService.InputBegan:Connect(function(Input)
                        if Input.UserInputType ~= Enum.UserInputType.MouseButton1 and Input.UserInputType ~= Enum.UserInputType.Touch then return end
                        if Library:IsMouseOverFrame(Items["ModeList"]) or Library:IsMouseOverFrame(Items["Modes"]) then return end
                        closeModeMenu()
                    end)
                end)
            end
            ...
            local function keyListStatusOn()
                if Keybind.syncFlag then return Library.Flags[Keybind.syncFlag] == true end
            ...
            function Keybind:SetMode(Mode, SkipCallback)
                ...
                if Items["ModeSelect"] then Items["ModeSelect"].Instance.Text = Mode .. "  ▾" end
                Library.Flags[Keybind.Flag] = { Mode = Keybind.ModeSelected, Key = Keybind.Key, Toggled = Keybind.Toggled }
                if Data.Callback and not SkipCallback then Library:SafeCall(Data.Callback, Keybind.Toggled) end
            end
            ...
            function Keybind:Set(Key, SkipCallback)
                ...
                elseif type(Key) == "table" then
                    ...
                    if Key.Mode then Keybind:SetMode(Key.Mode, SkipCallback) else Keybind:SetMode("Toggle", SkipCallback) end
                    if Data.Callback and not SkipCallback then Library:SafeCall(Data.Callback, Keybind.Toggled) end
                    Update()
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                ...
                if Keybind.Value == "None" or Keybind.Value == nil or Keybind.Value == "" then return end
                local matched = false
                if Keybind.CodeName then matched = Input.UserInputType == Enum.UserInputType.Keyboard and Input.KeyCode.Name == Keybind.CodeName
                elseif Keybind.Key then matched = tostring(Input.UserInputType) == Keybind.Key end
                if matched then
                    local now = tick()
                    if Keybind._lastInputAt and (now - Keybind._lastInputAt) < 0.08 then return end
                ...
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    if (Items["KeybindWindow"] and Library:IsMouseOverFrame(Items["KeybindWindow"])) or (Items["OptionHolder"] and Library:IsMouseOverFrame(Items["OptionHolder"])) then return end
            ...
            Library:Connect(UserInputService.InputEnded, function(Input)
                ...
                if matched then
                    local now = tick()
                    if Keybind._lastInputEndAt and (now - Keybind._lastInputEndAt) < 0.06 then return end
            ...
            if showRows == nil then showRows = not IsMobile end
        ...
        Library.Sections.Textbox = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["Textbox"].Instance, CornerRadius = UDimNew(0, 4)})
                Items["Background"] = Instances:Create("Frame", {
                ...
                Instances:Create("UICorner", {Parent = Items["Background"].Instance, CornerRadius = UDimNew(0, 4)})
            ...
            if Textbox.Finished then 
                Items["Input"]:Connect("FocusLost", function(PressedEnterQuestionMark)
                    if PressedEnterQuestionMark then Textbox:Set(Items["Input"].Instance.Text) end
                end)
            else
        ...
        Library.Sections.Listbox = function(self, Data)
            ...
            local Items = { } do 
                ...
                Instances:Create("UICorner", {Parent = Items["Search"].Instance, CornerRadius = UDimNew(0, 6)})
                Instances:Create("UIPadding", {Parent = Items["Search"].Instance, PaddingTop = UDimNew(0, 4), PaddingLeft = UDimNew(0, 8)})
                Items["Background"] = Instances:Create("Frame", {
                    Parent = Items["Listbox"].Instance,
                    Name = "\0",
                    Active = true,
                ...
                Instances:Create("UIListLayout", {Parent = Items["Holder"].Instance, Padding = UDimNew(0, 4), SortOrder = Enum.SortOrder.LayoutOrder})
                Instances:Create("UIPadding", {Parent = Items["Holder"].Instance, PaddingTop = UDimNew(0, 8), PaddingBottom = UDimNew(0, 8), PaddingRight = UDimNew(0, 12), PaddingLeft = UDimNew(0, 8)})      
                ...
                Instances:Create("Frame", {Parent = Items["_"].Instance, Size = UDim2New(1, 0, 0, 1), Position = UDim2New(0, 0, 1, -3), AnchorPoint = Vector2New(0, 1), BorderColor3 = FromRGB(0, 0, 0), ZIndex = 2, BorderSizePixel = 0, BackgroundColor3 = FromRGB(27, 26, 29)}):AddToTheme({BackgroundColor3 = "Outline"})
            end
                ...
                function OptionData:Search(Bool)
                    Library:Thread(function()
                        if Bool then 
                            ...
                            if OptionData.Selected then OptionAccent:Tween(TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 1}) end
                        else
                            ...
                            if OptionData.Selected then OptionAccent:Tween(TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0}) end
                        end
                    end)
                end
                function OptionData:Set()
                    ...
                    if Dropdown.Multi then 
                        ...
                        if OptionData.Selected then 
                            ...
                            OptionData:Toggle("Active")
                            for Index, Value in Dropdown.Options do 
                                if Value ~= OptionData and not Value.IsSearching then Value.Selected = false Value:Toggle("Inactive") end
                            end
                        else
                            Dropdown.Value = nil
                            Library.Flags[Dropdown.Flag] = nil
        ...
        Library.CreateSettingsPage = function(self, Window, KeybindList, Options)
            ...
            local Page = Window:Tab(pageInfo)
            local UISection = Page:Section({Name = "Appearance", Icon = "palette", Side = 1}) do
                UISection:Label("Accent color"):Colorpicker({
                    Flag = "AccentColor",
                    Default = Library.Theme.Accent,
                    Callback = function(Color) Library.Theme.Accent = Color Library:ChangeTheme("Accent", Color) end
                })
                UISection:Label("Accent gradient"):Colorpicker({
                    Flag = "AccentGradientColor",
                    Default = Library.Theme.AccentGradient,
                    Callback = function(Color) Library.Theme.AccentGradient = Color Library:ChangeTheme("AccentGradient", Color) end
                })
                UISection:Dropdown({
                    Name = "Font weight",
                    Flag = "FontStyle",
                    ...
                    Callback = function(Value) if Library.Fonts[Value] then Library.Font = Library.Fonts[Value]; Library:UpdateText() end end
                })
                UISection:Slider({
                ...
                UISection:Toggle({
                    ...
                    Callback = function(v) if Library.FloatingButtonWidget and Library.FloatingButtonWidget.Instance then Library.FloatingButtonWidget.Instance.Visible = v end end
                })
                UISection:Toggle({
                    Name = "Custom Cursor",
                    ...
                    Callback = function(v) Library:SetCustomCursor(v) end
                })
                UISection:Toggle({
                    ...
                    Callback = function(v) Library:SetKeybindRowsVisible(v) end
                })
                task.defer(function()
                    pcall(function()
                        if Library.Flags.CustomCursorEnabled then Library:SetCustomCursor(true) end
                        if Library.FloatingButtonWidget and Library.FloatingButtonWidget.Instance then Library.FloatingButtonWidget.Instance.Visible = Library.Flags.FloatingButtonVisible ~= false end
            ...
            if not IsMobile then
                local KeybindSection = Page:Section({Name = "Keybinds", Icon = "keyboard", Side = 1}) do
                    ...
                    KeybindSection:Keybind({
                        ...
                        Callback = function()
                            if Library.Flags.MenuKeybindEnabled == false then return end
                            local now = tick()
                            if Library._lastMenuToggleAt and (now - Library._lastMenuToggleAt) < 0.2 then return end
            ...
            local ConfigsSection = Page:Section({Name = "Configs", Side = 1, LayoutOrder = 5}) do
                local ConfigName
                ...
                ConfigsSection:Button({ Name = "Delete", Callback = function()
                    if ConfigSelected then Library:DeleteConfig(ConfigSelected) Library:RefreshConfigsList(ConfigsDropdown) end
                end })
                ConfigsSection:Button({ Name = "Load", Callback = function()
                    ...
                    if fn and isfile(Library.Folders.Configs .. "/" .. fn) then Library:LoadConfig(readfile(Library.Folders.Configs .. "/" .. fn)) end
                end })
                ConfigsSection:Button({ Name = "Save", Callback = function()
                    if not ConfigSelected then return end
                    local fn = Library:ConfigDisplayToFile(ConfigSelected)
                    if fn then writefile(Library.Folders.Configs .. "/" .. fn, Library:GetConfig()) Library:RefreshConfigsList(ConfigsDropdown) end
                end })
