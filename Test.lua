...
local function createSectionBuilder(parent, contentContainer, elementWidth, windowCount, window)
    ...
    local function createSection(text, icons, defaultOpen)
        ...
        child.Slider = function(_, config)
            ...
            TitleLbl.Size = UDim2.new(0,90,0,rowH)
            ...
            ValueFrame.BackgroundTransparency = 0.08
            ValueFrame.Parent = Tile
            Instance.new("UICorner", ValueFrame).CornerRadius = UDim.new(0,4)
            AddToRegistry(ValueFrame, "BackgroundColor3", "Main")

            local ValueStroke = Instance.new("UIStroke")
            ValueStroke.Thickness = 1
            ValueStroke.Transparency = 0.75
            ValueStroke.Parent = ValueFrame
            AddToRegistry(ValueStroke, "Color", "Stroke")
            ...
            Num.Parent = ValueFrame
            AddToRegistry(Num, "TextColor3", "Accent")
            Num.Focused:Connect(function() Tween(ValueStroke, {Transparency=0.2}, 0.15) end)
            ...
            Num.FocusLost:Connect(function()
                Tween(ValueStroke, {Transparency=0.75}, 0.15)
