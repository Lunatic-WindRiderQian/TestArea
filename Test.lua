        ...
        function Window:Tab(name, icon)
            ...
            local function selectTab()
                ...
                if Window._activeTab then
                    ...
                    if oldGlow then
                        Tween(oldGlow, {BackgroundTransparency = 1}, 0.3)
                        local oldGlowImage = oldGlow:FindFirstChild("GlowImage")
                        if oldGlowImage then
                            Tween(oldGlowImage, {ImageTransparency = 1}, 0.3)
                        end
                    end
                ...
                if newGlow then
                    Tween(newGlow, {BackgroundTransparency = 0}, 0.3)
                    local newGlowImage = newGlow:FindFirstChild("GlowImage")
                    if newGlowImage then
                        Tween(newGlowImage, {ImageTransparency = 0.69}, 0.3)
                    end
                end
            ...
            if not Window._activeTab then
                ...
                if glow then
                    ...
                    local glowImage = glow:FindFirstChild("GlowImage")
                    if glowImage then
