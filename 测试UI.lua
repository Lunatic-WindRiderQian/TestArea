...
function DigitalParticleExplosion(obj)
    ...
    task.spawn(function()
        ...
        explosionCenter.BackgroundColor3 = Color3.fromRGB(0, 170, 255)
        ...
        centerGlow.Color = Color3.fromRGB(0, 170, 255)
        ...
        shockwaveStroke.Color = Color3.fromRGB(0, 170, 255)
...
CloseButton.MouseButton1Click:Connect(function()
    ...
    services.TweenService:Create(Main, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
...
local function playEntranceAnimation()
    ...
    services.TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
function FengUI.new(FengUI, name, theme)
    ...
    playerStroke.Color = config.BorderColor
    ...
    AlbumArt.BackgroundTransparency = 0
    ...
    albumStroke.Color = config.BorderColor
    albumStroke.Thickness = 1
    albumStroke.Transparency = 0
    ...
    local function createControlButton(name, text, position, size, isMain)
        ...
        button.BackgroundColor3 = isMain and config.AccentColor or Color3.fromRGB(80, 80, 100)
        ...
        button.Text = text
        button.TextColor3 = isMain and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(220, 220, 220)
        ...
        buttonStroke.Color = isMain and Color3.fromRGB(0, 140, 225) : Color3.fromRGB(70, 70, 90)
        ...
        button.MouseEnter:Connect(function()
            services.TweenService:Create(button, TweenInfo.new(0.2), {
                BackgroundColor3 = isMain and Color3.fromRGB(0, 190, 255) : Color3.fromRGB(100, 100, 120)
            }):Play()
        end)
        
        button.MouseLeave:Connect(function()
            services.TweenService:Create(button, TweenInfo.new(0.2), {
                BackgroundColor3 = isMain and config.AccentColor : Color3.fromRGB(80, 80, 100)
            }):Play()
        end)
            ...
            function section.Button(section, text, callback)
                ...
                Btn.MouseEnter:Connect(function()
                    services.TweenService:Create(Btn, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(
                            math.min(255, math.floor(config.Button_Color.R * 255 * 1.2)),
                            math.min(255, math.floor(config.Button_Color.G * 255 * 1.2)),
                            math.min(255, math.floor(config.Button_Color.B * 255 * 1.2))
                        )
                    }):Play()
                end)
                ...
                Btn.MouseButton1Click:Connect(function()
                    ...
                    services.TweenService:Create(Btn, TweenInfo.new(0.1), {
                        BackgroundColor3 = Color3.fromRGB(
                            math.max(0, math.floor(config.Button_Color.R * 255 * 0.8)),
                            math.max(0, math.floor(config.Button_Color.G * 255 * 0.8)),
                            math.max(0, math.floor(config.Button_Color.B * 255 * 0.8))
                        )
                    }):Play()
    ...
    return imageController
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtn.MouseEnter:Connect(function()
                    services.TweenService:Create(ToggleBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(
                            math.min(255, math.floor(config.Toggle_Color.R * 255 * 1.2)),
                            math.min(255, math.floor(config.Toggle_Color.G * 255 * 1.2)),
                            math.min(255, math.floor(config.Toggle_Color.B * 255 * 1.2))
                        )
                    }):Play()
                end)
                ...
                local funcs = {
                    SetState = function(self, state)
                        ...
                        services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            ...
            function section.Keybind(section, text, default, callback)
                ...
                valueStroke.Color = config.BorderColor
                ...
                KeybindBtn.MouseEnter:Connect(function()
                    services.TweenService:Create(KeybindBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(
                            math.min(255, math.floor(config.Keybind_Color.R * 255 * 1.2)),
                            math.min(255, math.floor(config.Keybind_Color.G * 255 * 1.2)),
                            math.min(255, math.floor(config.Keybind_Color.B * 255 * 1.2))
                        )
                    }):Play()
                end)
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxBack.MouseEnter:Connect(function()
                    services.TweenService:Create(TextboxBack, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(
                            math.min(255, math.floor(config.Textbox_Color.R * 255 * 1.2)),
                            math.min(255, math.floor(config.Textbox_Color.G * 255 * 1.2)),
                            math.min(255, math.floor(config.Textbox_Color.B * 255 * 1.2))
                        )
                    }):Play()
                end)
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                valStroke.Color = config.BorderColor
