...
local config = {
    ...
    Button_Color = Color3.fromRGB(25, 25, 30),
    Textbox_Color = Color3.fromRGB(25, 25, 30),
    Dropdown_Color = Color3.fromRGB(25, 25, 30),
    Keybind_Color = Color3.fromRGB(25, 25, 30),
    Label_Color = Color3.fromRGB(25, 25, 30),
    Slider_Color = Color3.fromRGB(25, 25, 30),
    SliderBar_Color = Color3.fromRGB(120, 220, 255),
    Toggle_Color = Color3.fromRGB(25, 25, 30),
    Toggle_Off = Color3.fromRGB(40, 40, 45),
    Toggle_On = Color3.fromRGB(120, 220, 255),
    AccentColor = Color3.fromRGB(120, 220, 255),
    TextColor = Color3.fromRGB(245, 245, 250),
    SecondaryTextColor = Color3.fromRGB(170, 170, 180),
    GlowColor = Color3.fromRGB(100, 200, 255),
}

-- 新的霓虹光效
local function createNeonEffect(object, thickness, transparency)
    local neon = Instance.new("UIStroke")
    neon.Parent = object
    neon.Color = config.AccentColor
    neon.Thickness = thickness or 2
    neon.Transparency = transparency or 0.7
    ...
    connection = RunService.Heartbeat:Connect(function()
        ...
        hue = (hue + 0.015) % 1
        neon.Color = Color3.fromHSV(hue, 0.8, 1)
    end)
...
-- 新的粒子效果
local function createParticleEffect(frame, intensity)
    ...
    particles.ZIndex = frame.ZIndex - 1
    ...
    local function createParticle()
        ...
        particle.Position = UDim2.new(0, math.random(-10, frame.AbsoluteSize.X), 0, -10)
        ...
        services.TweenService:Create(particle, TweenInfo.new(math.random(2, 4), Enum.EasingStyle.Linear), {
            Position = UDim2.new(0, math.random(-10, frame.AbsoluteSize.X), 1, 10),
            BackgroundTransparency = 1
        }):Play()
        
        delay(math.random(2, 4), function()
            if particle then
                particle:Destroy()
            end
        end)
    ...
    for i = 1, 15 * intensity do
        delay(math.random() * 2, createParticle)
    end
...
local function setupHoverAnimation(button)
    ...
    button.MouseEnter:Connect(function()
        services.TweenService:Create(button, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            Size = originalSize + UDim2.new(0.02, 0, 0.02, 0),
            Position = originalPosition - UDim2.new(0.01, 0, 0.01, 0)
        }):Play()
    end)
...
function switchTab(new)
    ...
    if old == nil then
        ...
        services.TweenService:Create(new[1], TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { 
            ImageTransparency = 0,
            Rotation = 0
        }):Play()
...
BackgroundBlur.BackgroundTransparency = 0.9
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://7733674079"
...
createNeonEffect(Open, 2, 0.6)

-- 添加粒子效果到打开按钮
createParticleEffect(Open, 0.5)
...
Open.MouseButton1Click:Connect(function()
    ...
    services.TweenService:Create(Open, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
        ...
        Size = Main.Visible and UDim2.new(0, 50, 0, 50) or UDim2.new(0, 45, 0, 45)
    }):Play()
end)
...
TabMain.Size = UDim2.new(0, 370, 0, 290)
...
Side.Size = UDim2.new(0, 92, 0, 300)
...
TabBtns.Size = UDim2.new(0, 92, 0, 250)
...
ScriptTitle.Size = UDim2.new(0, 92, 0, 25)
...
task.spawn(function()
    ...
    while ScriptTitle and ScriptTitle.Parent do
        hue = (hue + 0.01) % 1
        ScriptTitle.TextColor3 = Color3.fromHSV(hue, 0.9, 1)
        
        services.TweenService:Create(ScriptTitle, TweenInfo.new(1, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {
            TextSize = 18 + math.sin(tick() * 3) * 2
        }):Play()
...
function FengUI.new(FengUI, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://7733674079"
        TabIco.ImageTransparency = 0.7
        
        createNeonEffect(TabIco, 1, 0.8)
        
        TabText.Name = "TabText"
        TabText.Parent = TabIco
        TabText.BackgroundTransparency = 1
        TabText.Position = UDim2.new(1.1, 0, 0, 0)
        TabText.Size = UDim2.new(0, 60, 0, 28)
        TabText.Font = Enum.Font.GothamSemibold
        TabText.Text = name
        TabText.TextColor3 = config.SecondaryTextColor
        TabText.TextSize = 13
        TabText.TextXAlignment = Enum.TextXAlignment.Left
        TabText.TextTransparency = 0.7
        
        TabBtn.Name = "TabBtn"
        TabBtn.Parent = TabIco
        TabBtn.BackgroundTransparency = 1
        TabBtn.BorderSizePixel = 0
        TabBtn.Size = UDim2.new(0, 92, 0, 28)
        ...
        function tab.section(tab, name, TabVal)
            ...
            createNeonEffect(Section, 1, 0.8)
            ...
            SectionOpen.Image = "rbxassetid://7733760431"
            ...
            SectionOpened.Image = "rbxassetid://7733760431"
            ...
            SectionToggle.MouseButton1Click:Connect(function()
                open = not open
                services.TweenService:Create(Section, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
            ...
            function section.Button(section, text, callback)
                ...
                BtnModule.Size = UDim2.new(0, 340, 0, 38)
            ...
            function section.Image(section, imageId, sizeX, sizeY)
                ...
                ImageModule.Size = UDim2.new(0, 340, 0, sizeY or 130)
                ...
                ImageLabel.Size = UDim2.new(0, math.min(sizeX or 150, 330), 0, sizeY or 130)
                ...
                createNeonEffect(ImageLabel, 1, 0.7)
            ...
            function section:Label(text)
                ...
                LabelModule.Size = UDim2.new(0, 340, 0, 28)
                
                TextLabel.Parent = LabelModule
                TextLabel.BackgroundColor3 = config.Label_Color
                TextLabel.BackgroundTransparency = 0.1
                TextLabel.Size = UDim2.new(0, 340, 0, 32)
                ...
                createNeonEffect(TextLabel, 1, 0.8)
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtn.Size = UDim2.new(0, 340, 0, 38)
                ...
                createNeonEffect(ToggleBtn, 1, 0.8)
                ...
                ToggleDisable.Position = UDim2.new(0.85, 0, 0.21, 0)
                ...
                if enabled then
                    createNeonEffect(ToggleSwitch, 1, 0.5)
                end
                ...
                local funcs = {
                    SetState = function(self, state)
                        ...
                        services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
                        ...
                        if state then
                            ...
                            local neon = ToggleSwitch:FindFirstChild("UIStroke")
                            if neon then
                                neon:Destroy()
                            end
                        end
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindModule.Size = UDim2.new(0, 340, 0, 38)
                ...
                KeybindBtn.Size = UDim2.new(0, 340, 0, 38)
                ...
                createNeonEffect(KeybindBtn, 1, 0.8)
                ...
                KeybindValue.Position = UDim2.new(0.72, 0, 0.21, 0)
                KeybindValue.Size = UDim2.new(0, 74, 0, 24)
                ...
                createNeonEffect(KeybindValue, 1, 0.7)
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxModule.Size = UDim2.new(0, 340, 0, 38)
                ...
                TextboxBack.Size = UDim2.new(0, 340, 0, 38)
                ...
                createNeonEffect(TextboxBack, 1, 0.8)
                ...
                BoxBG.Position = UDim2.new(0.45, 0, 0.21, 0)
                BoxBG.Size = UDim2.new(0, 84, 0, 24)
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderModule.Size = UDim2.new(0, 340, 0, 38)
                ...
                SliderBack.Size = UDim2.new(0, 340, 0, 38)
                ...
                createNeonEffect(SliderBack, 1, 0.8)
                ...
                SliderBar.Size = UDim2.new(0, 124, 0, 16)
                ...
                createNeonEffect(SliderPart, 1, 0.5)
                
                SliderValBG.Name = "SliderValBG"
                SliderValBG.Parent = SliderBack
                SliderValBG.BackgroundColor3 = config.Bg_Color
                SliderValBG.BorderSizePixel = 0
                SliderValBG.Position = UDim2.new(0.82, 0, 0.21, 0)
                ...
                createNeonEffect(SliderValBG, 1, 0.7)
                ...
                MinSlider.Position = UDim2.new(0.28, 0, 0.21, 0)
                ...
                createNeonEffect(MinSlider, 1, 0.7)
                setupHoverAnimation(MinSlider)
                ...
                AddSlider.Position = UDim2.new(0.75, 0, 0.21, 0)
                ...
                createNeonEffect(AddSlider, 1, 0.7)
                setupHoverAnimation(AddSlider)
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownModule.Size = UDim2.new(0, 340, 0, 38)
                ...
                DropdownTop.Size = UDim2.new(0, 340, 0, 38)
                ...
                createNeonEffect(DropdownTop, 1, 0.8)
                ...
                DropdownOpenFrame.Size = UDim2.new(0, 38, 0, 24)
                DropdownOpenFrame.ZIndex = 2
                
                createNeonEffect(DropdownOpenFrame, 1, 0.7)
                ...
                DropdownText.Size = UDim2.new(0, 230, 0, 38)
                ...
                local ToggleDropVis = function()
                    ...
                    DropdownModule.Size = UDim2.new(0, 340, 0, (open and math.min(DropdownModuleL.AbsoluteContentSize.Y + 4, 150) or 38))
                end
                ...
                funcs.AddOption = function(self, option)
                    ...
                    Option.Size = UDim2.new(0, 320, 0, 26)
