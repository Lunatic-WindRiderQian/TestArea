...
local function createParticleTrail(startPos, endPos, parent)
    ...
    trail.BackgroundColor3 = Color3.new(1, 0, 0)
...
function window.Tab(window, name, icon, windowCount)
    ...
    TabIco.Name = "TabIco"
    TabIco.Parent = MainSideContainer
    TabIco.BackgroundTransparency = 1
    TabIco.BorderSizePixel = 0
    TabIco.Position = UDim2.new(0, 5, 0, 30)
    TabIco.Size = UDim2.new(0, 22, 0, 22)
                    ...
                    inputBox.FocusLost:Connect(function(enterPressed)
                        ...
                        if inputBox == HexInput then
                            ...
                            if num then
                                ...
                                local b = tonumber(BInput.Text)或 255
