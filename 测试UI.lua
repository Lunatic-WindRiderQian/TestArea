...
-- 静态星空背景（没有动画效果）
local function createStaticSpaceBackground(parent)
    local background = Instance.new("Frame")
    background.Name = "StaticSpaceBackground"
    background.BackgroundColor3 = config.DeepSpaceColor
    background.BackgroundTransparency = 0
    background.Size = UDim2.new(1, 0, 1, 0)
    background.ZIndex = 0
    background.Parent = parent
    background.ClipsDescendants = true  -- 确保内容不会超出边框
    ...
    starsContainer.ClipsDescendants = true  -- 确保星星不会超出边框
    
    -- 创建静态星光
    local function createStaticStars(count, size, brightness)
        for i = 1, count do
            ...
            star.Position = UDim2.new(0, math.random(0, 440), 0, math.random(0, 260))  -- 确保在边框内
            star.ZIndex = 1
    ...
    -- 创建三层不同大小和亮度的星光（静态）
    createStaticStars(40, 1, 0.8)  -- 远景星光
    createStaticStars(25, 2, 0.9)  -- 中景星光
    createStaticStars(12, 3, 1.0)  -- 近景星光
...
Main.Active = true
Main.Draggable = true
Main.ClipsDescendants = true  -- 确保内容不会超出边框

-- 静态星空背景
createStaticSpaceBackground(Main)
...
TitleBar.BackgroundColor3 = config.ElementColor
...
TabMain.Position = UDim2.new(0, 90, 0, 40)
TabMain.Size = UDim2.new(0, 355, 0, 235)
TabMain.Visible = false
TabMain.ClipsDescendants = true  -- 确保内容不会超出边框

-- 侧边栏
local Side = Instance.new("Frame")
Side.Name = "Side"
Side.Parent = Main
Side.BackgroundColor3 = config.ElementColor
...
TabBtns.ClipsDescendants = true  -- 确保内容不会超出边框
...
function FengUI.new(FengUI, name, theme)
    ...
    function window.Tab(window, name, icon)
        ...
        Tab.ClipsDescendants = true  -- 确保内容不会超出边框
        ...
        function tab.section(tab, name, TabVal)
            ...
            Section.Parent = Tab
            Section.BackgroundColor3 = config.ElementColor
            Section.BackgroundTransparency = 0.8
            Section.BorderSizePixel = 0
            Section.ClipsDescendants = true
            Section.Size = UDim2.new(1, -10, 0, 42)
            ...
            if TabVal ~= false then
                Section.Size = UDim2.new(1, -10, 0, open and 42 + ObjsL.AbsoluteContentSize.Y + 8 or 42)
            ...
            SectionToggle.MouseButton1Click:Connect(function()
                ...
                services.TweenService:Create(Section, TweenInfo.new(0.3, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {
                    Size = UDim2.new(1, -10, 0, open and 42 + ObjsL.AbsoluteContentSize.Y + 8 or 42)
                }):Play()
            ...
            ObjsL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                ...
                Section.Size = UDim2.new(1, -10, 0, 42 + ObjsL.AbsoluteContentSize.Y + 8)
            end)
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindModule.Size = UDim2.new(1, 0, 0, 44)
                ...
                KeybindBtn.Size = UDim2.new(1, 0, 0, 44)
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxModule.Size = UDim2.new(1, 0, 0, 44)
                ...
                TextboxBack.Size = UDim2.new(1, 0, 0, 44)
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderModule.Size = UDim2.new(1, 0, 0, 44)
                ...
                SliderBack.Size = UDim2.new(1, 0, 0, 44)
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownModule.Size = UDim2.new(1, 0, 0, 44)
                ...
                DropdownText.Size = UDim2.new(0, 180, 0, 44)
                ...
                local ToggleDropVis = function()
                    ...
                    DropdownModule.Size = UDim2.new(1, 0, 0, open and (44 + DropdownModuleL.AbsoluteContentSize.Y + 4) or 44)
                end
                ...
                DropdownModuleL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                    if open then
                        DropdownModule.Size = UDim2.new(1, 0, 0, 44 + DropdownModuleL.AbsoluteContentSize.Y + 4)
                    end
                end)
